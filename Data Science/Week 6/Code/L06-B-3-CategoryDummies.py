...
# The above takes care of all possibilties
...
#  Same as above, the above three take care of all possibities
...
#### One hot encoding, makes a new column for each possiblities
#### dummy_variabes makes N-1 columns